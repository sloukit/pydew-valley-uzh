...
class SettingsMenu(GeneralMenu):
    def __init__(
        ...
        options = [
            get_translated_string("Volume"),
            get_translated_string("Back"),
        ]  # used to include get_translated_string("Keybinds"),
