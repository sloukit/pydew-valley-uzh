...
class Tutorial:
    ...
    def __init__(
        ...
        self.dialogue_manager = DialogueManager(sprite_group, "data/textboxes/tutorial.json")
        self.player = player
        self.level = level
    ...
    def get_hat_ingroup(self):
        self.dialogue_manager.open_dialogue("Get_hat_from_ingroup", self.left_pos, self.top_pos)

    def get_necklace_ingroup(self):
        self.dialogue_manager.open_dialogue("Get_necklace_from_ingroup", self.left_pos, self.top_pos)

    def go_to_forest_and_hit_tree(self):
        self.dialogue_manager.open_dialogue("Go_to_forest_and_hit_tree", self.left_pos, self.top_pos)
    ...
    def go_to_minigame_map_and_play(self):
        self.dialogue_manager.open_dialogue("Go_to_minigame_map_and_play", self.left_pos, self.top_pos)

    def move(self):
        self.dialogue_manager.open_dialogue("Basic_movement", self.left_pos, self.top_pos)

    def interact_with_ingroup_member(self):
        self.dialogue_manager.open_dialogue("Interact_with_ingroup_member", self.left_pos, self.top_pos)

    def interact_with_outgroup_member(self):
        self.dialogue_manager.open_dialogue("Interact_with_outgroup_member", self.left_pos, self.top_pos)
    ...
    def walk_around_outgroup_farm_and_switch_to_outgroup(self):
        self.dialogue_manager.open_dialogue("Walk_around_outgroup_farm_and_switch_to_outgroup", self.left_pos, self.top_pos)
    ...
    def check_tasks(self, game_paused):
        match(self.tasks_achieved):
            case 0: 
                ...
                if (0 not in self.movement_axis 
            ...
            case 1:
                ...
                if (self.dialogue_manager._get_current_tb().finished_advancing 
            ...
            case 3:
                ...
                if (True in self.level.crop_planted
                    and self.dialogue_manager._get_current_tb().finished_advancing):
            ...
            case 6:
                ...
                if (self.player.buyed_selled and not game_paused
                    and self.dialogue_manager._get_current_tb().finished_advancing):
            ...
            case 7:
                ...
                if (self.player.minigame_finished
                    and self.dialogue_manager._get_current_tb().finished_advancing):
            ...
            case 8:
                ...
                if (self.player.outgroup_member_interacted
                    and self.dialogue_manager._get_current_tb().finished_advancing):
